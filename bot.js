...
if (message.content.startsWith(prefix + 'help')) { /// This is The DMS Code Send The Help In DMS // Code By NotGucci
    let pages = [`**
        ***__General orders__***
**
${prefix}بوتات/لعرض جميع البوتات الي بالسيرفر
${prefix}سيرفر/يعرض لك معلومات عن السيرفر
${prefix}بوت/يعرض لك كل معلومات البوت
${prefix}عدد الاشخاص بلسيرفر/يعرض لك عدد الاشخاص بالسيرفر بدون بوتات
${prefix}دعوات/ يعرض لك  عدد انفايتاتك بالسيرفر 
${prefix}معلومات دعوه/ لمعلومات عن الدعوه
 مثال : invinfo m82n8P
${prefix}كود الدعوات/يعرض لك روابط الانفايتات حكك في السيرفر 
${prefix}اله حاسبه/اله حاسبة
${prefix}ترجمه/يترجم لك الي تبيه من اي لغة
${prefix}اختصار/يختصر لك رابط كبير الى رابط صغير
${prefix}تاج/يكتب لك الكلمة بشكل جميل وكبير
${prefix}جوجل/للبحث في قوقل عن طريق الدسكورد
${prefix}perms/يعرض لك برمشناتك بالسيرفر
${prefix}زخرفه/يزخرف لك كلمة او جملة
${prefix}الرومات/يعرض لك كل الرومات الي بالسيرفر مع عددها
${prefix}رتب/يعرض لك كل الرانكات بالسيرفر بشكل جميل
${prefix}اموجي/يعرض لك كل الايموجيات الي بالسيرفر
${prefix}تكرير/يكرر الكلام الي تكتبو
${prefix}صوره السيرفر/صورة السيرفر
${prefix}اعضاء/عرض لك عدد كل حالات الاشخاص وعدد البوتات وعدد الاشخاص
${prefix}معلومات عني/معلومات عنك
${prefix}باند / عدد الاشخاص المبندة 
${prefix}صورتي/صورتك او صورة الي تمنشنو
${prefix}كرر2/يكرر الي تقولو بشكل حلو
${prefix}تحويل اموجي/لتحويل اي كلمه تقولها الي ايموجي
${prefix}دعوه بوت/لدعوة البوت الى سيرفرك
${prefix}الدعم/سيرفر الدعم
${prefix}اقتراح/ارسال اقتراح او لمراسلة صاحب البوت
**
  `
,`
...
${prefix}رساله للاعضاء / رسالة جماعية الى كل اعضاء السيرفر
${prefix}رساله للرتبه / رسالة جماعيه مع
${prefix}rolebc <everyone or @role> / راسال رساله جماعيه لرتبه محدده
${prefix}role @user <rank> / لأعطاء رتبة لعضو معين
${prefix}ازاله الرول لازالة الرتبة من شخص معين
${prefix}رتبه جماعيه/ لأعطاء رتبة للجميع
${prefix}رتبه فرديه/ لأعطاء رتبة للاشخاص فقط
${prefix}رتبه بوت / لأعطاء رتبة لجميع البوتات
${prefix}ميوت شات/ اخفاء الشات
${prefix}فك ميوت الشات/ اضهار الشات المخفية
${prefix}مسح <numbr> / مسح الشات بعدد
${prefix}مسح الشات/ مسح الشات
...
${prefix}ميوت شات / تقفيل الشات
${prefix}فك ميوت الشات / فتح الشات
...
${prefix}توقف/ إيقآف الأغنية مؤقتا
${prefix}تكمله / لموآصلة الإغنية بعد إيقآفهآ مؤقتا
...
**
        ***__Games orders__***
 **       
${prefix}حجره ورقه مقص / حجر ورقة مقص
${prefix}بسرعه / اسرع كتابة
${prefix}اساله/ اسئلة عامة
${prefix}نكت / نكت 
${prefix}لعبة فكك / فكك
